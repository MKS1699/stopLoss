...
const TitleBar = () => {
  return (
    <div className="bg-light dark:bg-dark grid grid-rows-1 grid-cols-[10%_80%_10%] lg:grid-cols-[30%_25%_40%_5%] xl:grid-cols-[25%_25%_45%_5%] 2xl:grid-cols-[20%_25%_50%_5%] lg:gap-0 transition-all ease-in py-1 border-b-2 border-solid border-b-dark dark:border-b-light">
      {/* Mobile Nav Menu */}
