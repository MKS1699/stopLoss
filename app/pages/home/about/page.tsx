  ...
  return (
    <>
      <div className="min-h-screen max-h-max p-3 mb-4">
        <div className="text-justify text-base lg:text-xl text-dark dark:text-light">
          Welcome to&nbsp;
          <span className="cursor-pointer ">
            <a href="https://stoplos.live">STOPLOSS</a>
          </span>
          , your ultimate destination for all things stock market. We&apos;re
          not your typical finance platform; we&apos;re your financial companion
          in this rollercoaster of market highs and lows. At{" "}
          <span className="cursor-pointer ">
          ...
          you&apos;re a seasoned trader or just dipping your toes into the
          market, we&apos;ve got your back. Our team of experts is committed to
          providing you with real-time updates, in-depth analysis, and market
          trends, all delivered in a language that&apos;s as approachable as
          your favorite coffee shop conversation. No confusing jargon, just the
          information you need to make informed decisions. But we&apos;re more
          than just numbers and charts. We&apos;re a community of like-minded
          individuals who share a passion for financial growth. Join us as we
          navigate the exciting world of stocks together, helping you build
          confidence in your financial journey. So, buckle up and explore the
          world of finance with{" "}
          <span className="cursor-pointer ">
