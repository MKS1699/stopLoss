...
const SignUp = () => {
  return (
    <>
      {/* mobile view */}
      <div className="w-full h-full grid grid-cols-1 grid-rows-[10%_30%_5%_55%] md:hidden bg-bodyDark">
        <MastHead />
      ...
      {/* desktop view */}
      <div className="hidden md:w-full md:h-full md:grid md:grid-rows-1 md:grid-cols-1 bg-dark md:px-20 lg:px-24 xl:px-28 2xl:px-32 md:py-16 xl:py-20 2xl:py-24">
