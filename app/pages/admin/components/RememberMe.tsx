  ...
  return (
    <div className="w-full h-full grid grid-cols-[40%_25%_35%] grid-rows-1 text-base items-center md:text-sm xl:text-base">
      ...
      <div className="px-1">
        ...
        <label
          htmlFor={checkBoxId}
          className="text-[#355B3E] dark:text-[#4cb050] cursor-pointer"
        >
          Remember me
        </label>
      </div>
      ...
      <div
        className="w-full h-fit text-[#355B3E] dark:text-[#4cb050] self-center justify-self-center grid grid-flow-col text-sm items-center cursor-pointer 2xl:text-base"
      ...
      <div className="text-[#003B31] dark:text-white justify-self-end cursor-pointer">
        Forgot Password
      </div>
    </div>
  );
