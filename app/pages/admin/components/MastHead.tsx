...
const MastHead = ({ className }: StyledComponent) => {
  return (
    <div
      className={`w-full h-full grid grid-rows-1 grid-cols-[80%_20%] items-center  transition-all ease-in ${className}`}
    >
      {/* Image */}
      {/* <Image
        src={Logo}
      ...
      /> */}
      <div
        className={`${barlow.className} font-thin text-5xl justify-self-center md:text-3xl lg:text-4xl xl:text-6xl z-10 text-[#4CB050]`}
      >
        stoploss.live
      </div>
